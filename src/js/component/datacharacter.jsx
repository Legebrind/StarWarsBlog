...
const DataCharacters = ({theid}) => {
  ...
  return (
    ...
    <div className="card bg-dark text-warning customHeight w-25 container">
      <img src= {`https://starwars-visualguide.com/assets/img/characters/${parseInt(theid)+1}.jpg`} className="card-img-top" alt="..." />
      <div className="card-body">
        <h5 className="card-title">{store.character[theid].name}</h5>
