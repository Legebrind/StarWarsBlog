    ...
    case "character":
      return (
        ...
        <div className="card bg-dark text-warning customHeight w-25 container">
          <img src= {`https://starwars-visualguide.com/assets/img/characters/${parseInt(props.theid)+1}.jpg`} className="card-img-top" alt="..." />
      ...
      case "planet":{
        return (
          //Podia haber utilizado el item, pero he usado store para practicar.
          <div className="card bg-dark text-warning customHeight w-25 container">
            <img src={props.theid==0 ? "https://starwars-visualguide.com/assets/img/placeholder.jpg" :`https://starwars-visualguide.com/assets/img/planets/${parseInt(props.theid)+1}.jpg`} className="card-img-top" alt="..." />
            <div className="card-body">
        ...
        case "vehicle":{
          return (
            //Podia haber utilizado el item, pero he usado store para practicar.
            <div className="card bg-dark text-warning customHeight w-25 container">
              <img src= {store.vehiclesurl[props.theid]} className="card-img-top" alt="..." />
              <div className="card-body">
